...
public class RoadScenario extends JPanel{
	//Inner class for random numbers
	...
	{
		System.out.println(String.format("## move1 ##"));
		if(ag.equals("pedestrian1"))
		{
			if(px<=1900&&px>=50)
	...
	{
		loopNo = RoadScenarioVar.total_Score_number * 1;
		System.out.println(String.format("#loopNo = %d", loopNo));

		// Generate random number 
    	double randGeek = Math.random();
    	System.out.println(String.format("#randGeek = %f", randGeek));

		if(ag.equals("pedestrian1"))
		{	
			//Generaterandom number 1-4
			
			int randomInteger = randomno.nextInt(4);

			//int randomInteger = rand.nextInt(4);
			double randomDoub = rand.nextDouble();
			double random1 = num.random(loopNo+1000);
			System.out.println(String.format("#random1 = %f", random1));
			random1 = randGeek;
			
			
			if (random1 < 0.25){
				randomInteger = 0;
			}else if(random1>=0.25 && random1<0.50){
				randomInteger = 1;
			}else if(random1>=0.50 && random1<0.75){
				randomInteger = 2;
			}else if(random1>=0.75){
				randomInteger = 3;
			}
			// double randomGaus = randomint.nextGaussian();

			//System.out.println(String.format("#random_move randomInt = %d", randomInteger));
			//System.out.println(String.format("#random_move randomDoub = %f", randomDoub));
			//System.out.println(String.format("#random_move randomGaus = %f", randomGaus));


			//Select pedestrian move based on number
			switch(randomInteger){
				case 0:
					//System.out.println(String.format("#random_move p1 move right"));
					RoadScenarioVar.g_pedestrian1_x+=1.5;
					// RoadScenarioVar.g_pedestrian2_x+=1.5;
					countA++;
					break;
				case 1:
					//System.out.println(String.format("#random_move p1 move left"));
					RoadScenarioVar.g_pedestrian1_x-=1.5;
					// RoadScenarioVar.g_pedestrian2_x-=1.5;
					countB++;
					break;
				case 2:
					//System.out.println(String.format("#random_move p1 move down"));
					RoadScenarioVar.g_pedestrian1_y+=1.5;
					// RoadScenarioVar.g_pedestrian2_y+=1.5;
					countC++;
					break;
				case 3:
					//System.out.println(String.format("#random_move p1 move up"));
					RoadScenarioVar.g_pedestrian1_y-=1.5;
					// RoadScenarioVar.g_pedestrian2_y-=1.5;
					countD++;
					break;
			...
			sumCount = countA+countD+countC+countB;
			if (sumCount>0){	
			double pcA = countA/sumCount, pcB = countB/sumCount, pcC = countC/sumCount, pcD = countD/sumCount;
			double rightBias = (countA - countB)/sumCount, downBias = (countC - countD)/sumCount;
			//System.out.println(String.format("#random_move countA = %d", countA));
			System.out.println(String.format("RLDU ratios = %f %f %f %f", pcA, pcB, pcC, pcD));
			System.out.println(String.format("rightBias = %f downBias = %f ", rightBias, downBias));
			}

			//Move randomly based on gaussian distribution
			// if(randomDoub<0.25){
			// 	//System.out.println(String.format("#random_move p1 move right"));
			// 	RoadScenarioVar.g_pedestrian1_x+=1.5;
			// }
			// else if(randomDoub>=0.25 && randomDoub<0.5){
			// 	//System.out.println(String.format("#random_move p1 move left"));
			// 	RoadScenarioVar.g_pedestrian1_x-=1.5;
			// }
			// else if(randomDoub>=0.50 && randomDoub<0.75){
			// 	//System.out.println(String.format("#random_move p1 move down"));
			// 	RoadScenarioVar.g_pedestrian1_y+=1.5;
			// }
			// else if(randomDoub>=0.75){
			// 	//System.out.println(String.format("#random_move p1 move up"));
			// 	RoadScenarioVar.g_pedestrian1_y-=1.5;
			// }
			//move pedestrian 1.5m
			...
			//double random1 = num.random(loopNo);
			//double random2 = num.random(loopNo);
			//int p1x=(int)(random1*10-5);				//random val -5 to +5
			//int p1y=(int)(random2*10-5);
			//System.out.println(String.format("#random_move p1dx = %d p1dy = ", p1x));
		...
		if(ag.equals("pedestrian2"))
		{
			...
			double random1 = num.random(loopNo);
			double random2 = num.random(loopNo);
			int p2x=(int)(random1*10-5);				//random val -5 to +5
			int p2y=(int)(random2*10-5);
		...
		if(ag.equals("pedestrian3"))
		{
			...
			RoadScenarioVar.g_pedestrian3_x=0;//p3x+RoadScenarioVar.g_pedestrian3_x;
			RoadScenarioVar.g_pedestrian3_y=0;}//p3y+RoadScenarioVar.g_pedestrian3_y;}
		if(ag.equals("pedestrian4"))
		{
			int p4x=(int)(10-Math.random()*20);
			int p4y=(int)(10-Math.random()*20);
			RoadScenarioVar.g_pedestrian4_x=50;//p4x+RoadScenarioVar.g_pedestrian4_x;
			RoadScenarioVar.g_pedestrian4_y=50;}//p4y+RoadScenarioVar.g_pedestrian4_y;}
		if(ag.equals("pedestrian5"))
		{
			int p5x=(int)(10-Math.random()*20);
			int p5y=(int)(10-Math.random()*20);
			RoadScenarioVar.g_pedestrian5_x=50;//p5x+RoadScenarioVar.g_pedestrian5_x;
			RoadScenarioVar.g_pedestrian5_y=50;}//p5y+RoadScenarioVar.g_pedestrian5_y;}
		if(ag.equals("pedestrian6"))
		{
			int p6x=(int)(10-Math.random()*20);
			int p6y=(int)(10-Math.random()*20);
			RoadScenarioVar.g_pedestrian6_x=50;//p6x+RoadScenarioVar.g_pedestrian6_x;
			RoadScenarioVar.g_pedestrian6_y=50;//p6y+RoadScenarioVar.g_pedestrian6_y;
		}
	...
	{
		 System.out.println(String.format("## walk_cross ##"));
		 if (ag.equals("pedestrian1"))
				{
